$(document).ready(function(){
    ...
    $("body").prepend('<button class="sidebar-toggle" aria-label="Menu" style="position: fixed;"><div class="sidebar-toggle-button"><span></span><span></span><span></span></div></button><div class="BlogAnchor">' + 
        '<p class="html_header">' + 
            '<span></span>' + 
        '</p>' + 
    ...
    $("body").find("h2,h3,h4").each(function(i,item){
        ...
        $("#AnchorContent").css('max-height', ($(window).height() - 80-20) + 'px');
...
function toggleSidebar(){
    $(".BlogAnchor").toggleClass("BlogAnchor-big-page");
    if (tmp == false){
        $("#write").css("margin","auto");
        $(".sidebar-toggle").css("width","40px");
        tmp = true
    }else{
        $("#write").css("margin","40px 40px 40px 270px");
        $(".sidebar-toggle").css("width","290px");
        tmp = false;
    }
    console.log(tmp)
    return false;
